...
- {id: I2C0_clock.outFreq, value: 18 MHz}
- {id: I2C1_clock.outFreq, value: 18 MHz}
- {id: I2C2_clock.outFreq, value: 18 MHz}
- {id: I2C3_clock.outFreq, value: 18 MHz}
...
- {id: SYSCON.I2C0CLKSEL.sel, value: SYSCON.MAINCLKPLLSEL}
- {id: SYSCON.I2C1CLKSEL.sel, value: SYSCON.MAINCLKPLLSEL}
- {id: SYSCON.I2C2CLKSEL.sel, value: SYSCON.MAINCLKPLLSEL}
- {id: SYSCON.I2C3CLKSEL.sel, value: SYSCON.MAINCLKPLLSEL}
...
void BOARD_BootClockFRO18M(void)
{
    ...
    CLOCK_Select(kI2C2_Clk_From_MainClk);                  /*!< select main clk for I2C2 */
    CLOCK_Select(kI2C3_Clk_From_MainClk);                  /*!< select main clk for I2C3 */
